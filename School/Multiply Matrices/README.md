<h2><a href="https://www.geeksforgeeks.org/problems/multiply-matrices/1?page=1&category=Matrix&difficulty=School,Basic&sortBy=submissions">Multiply Matrices</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two square Matrices A[][] and B[][]. Your task is to complete the function <strong>multiply</strong> which stores the multiplied matrices&nbsp;in a new matrix C[][].</span><br>
&nbsp;</p>
