<h2><a href="https://www.geeksforgeeks.org/problems/diagonal-sum0158/1?page=1&category=Matrix&difficulty=School,Basic&sortBy=submissions">Diagonal sum</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a square matrix of size <strong>n</strong><strong>×n</strong>. Your task is to calculate the sum of its diagonals.</span><br>
&nbsp;</p>
